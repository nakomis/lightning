...
tools. The pitch is the **single-machine edition** in [`localhost/` in claude-chats](https://github.com/nakomis/claude-chats/tree/main/localhost):
...
```bash
open talks/conversation-memory/slides.html
```
...
- **Longer (30 min):** expand slide 10 into the full reliability story, and add
  the distributed edition from [claude-chats](https://github.com/nakomis/claude-chats) as a "where this
  went next" coda.
